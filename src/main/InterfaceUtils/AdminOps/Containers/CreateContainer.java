...
public class CreateContainer {
	...
	public static void liquidMenu() throws IOException {
		try {
			System.out.println(ansi().fg(Ansi.Color.RED).render("Create Liquid Container"));
			System.out.println(ansi().fg(Ansi.Color.GREEN).render("Step 2 of 2"));
			ConsolePrompt prompt = new ConsolePrompt();
			PromptBuilder promptBuilder = prompt.getPromptBuilder();
			promptBuilder.createInputPrompt()
	...
	public static void refMenu() throws IOException {
		try {
			System.out.println(ansi().fg(Ansi.Color.RED).render("Create Refrigerated Container"));
			System.out.println(ansi().fg(Ansi.Color.GREEN).render("Step 2 of 2"));
			ConsolePrompt prompt = new ConsolePrompt();
			PromptBuilder promptBuilder = prompt.getPromptBuilder();
			promptBuilder.createInputPrompt()
	...
	public static void otMenu() throws IOException {
		try {
			System.out.println(ansi().fg(Ansi.Color.RED).render("Create Open Top Container"));
			System.out.println(ansi().fg(Ansi.Color.GREEN).render("Step 2 of 2"));
			ConsolePrompt prompt = new ConsolePrompt();
			PromptBuilder promptBuilder = prompt.getPromptBuilder();
			promptBuilder.createInputPrompt()
	...
	public static void osMenu() throws IOException {
		try {
			System.out.println(ansi().fg(Ansi.Color.RED).render("Create Open Side Container"));
			System.out.println(ansi().fg(Ansi.Color.GREEN).render("Step 2 of 2"));
			ConsolePrompt prompt = new ConsolePrompt();
			PromptBuilder promptBuilder = prompt.getPromptBuilder();
			promptBuilder.createInputPrompt()
