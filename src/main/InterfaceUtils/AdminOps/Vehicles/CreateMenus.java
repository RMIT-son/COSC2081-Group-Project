...
import de.codeshelf.consoleui.Basic;
...
public class CreateMenus {
	public static void basicMenu() throws IOException {
		try {
			...
			System.out.println(ansi().fg(Ansi.Color.YELLOW).render("Step 2 of 3"));
			...
			// Create Vehicle
			BasicTruck newVehicle = new BasicTruck(id ,vehicleName, fuel, fuelCapacity, carryCapacity);
			System.out.println(ansi().fg(Ansi.Color.GREEN).render("Created new vehicle: " + newVehicle.getName() b));
	...
	public static void reeferMenu() throws IOException {
		...
		try {
			...
			// Create Vehicle
			ReeferTruck newVehicle = new ReeferTruck(id ,vehicleName, fuel, fuelCapacity, carryCapacity);
	...
	public static void tankerMenu() throws IOException {
		...
		try {
			...
			// Create Vehicle
			TankerTruck newVehicle = new TankerTruck(id ,vehicleName, fuel, fuelCapacity, carryCapacity);
			System.out.println(ansi().fg(Ansi.Color.GREEN).render("Created new vehicle: " + newVehicle.getName()));
			newVehicle.createVehicle();
