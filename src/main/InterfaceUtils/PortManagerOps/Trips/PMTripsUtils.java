package main.InterfaceUtils.PortManagerOps.Trips;
...
public class PMTripsUtils {
	public static void view() throws IOException {
		boolean viewMenuSwitch = true;
		ArrayList<Trip> viewTripsList = (ArrayList<Trip>) portManaging.getTraffic();
	...
	public static void schedule() throws IOException {
		...
		try {
			System.out.println(ansi().fg(Ansi.Color.BLUE).render("Schedule new Trip"));
